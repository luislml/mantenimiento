...
<div class="form-group col-sm-12">
    ...
    {!! Form::label('periferico', 'PERIFERICO:') !!}
    {!! Form::select('nombre', [''=>'','MOUSE' => 'MOUSE', 'TECLADO' => 'TECLADO', 'PARLANTES' => 'PARLANTES'], null, ['class' => 'form-control']) !!}
</div>
</div><!-- /.row -->
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE UNIDAD:</label>
      <select name="unidad_id" id="unidadp" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE AREA:</label>
      <select name="area_id" id="areap" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE SUB AREA:</label>
      <select name="sub_area_id" id="subareap" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE USUARIO:</label>
      <select name="usuario_id" id="usuario_idp" class="form-control">
