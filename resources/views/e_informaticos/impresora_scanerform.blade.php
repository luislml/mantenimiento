...
<!-- Numero Serie Field -->
 ...
 {!! Form::hidden('nombre', null, ['class' => 'form-control' , 'id' => 'equipoid']) !!}
...
<div class="form-group col-sm-12">
    ...
    <!-- tipo_impresora Field -->
    <div class="col-lg-6">
        {!! Form::label('tipo_impresora', 'TIPO DE IMPRESORA:') !!}
        {!! Form::text('tipo_impresora', null, ['class' => 'form-control','onkeydown'=>'upperCaseF(this)']) !!}
    </div><!-- /.col-lg-6 --> 
</div><!-- /.row -->
<!-- Unidad Id Field -->
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE UNIDAD:</label>
      <select name="unidad_id" id="unidadim" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE AREA:</label>
      <select name="area_id" id="areaim" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE SUB AREA:</label>
      <select name="sub_area_id" id="subareaim" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE USUARIO:</label>
      <select name="usuario_id" id="usuario_idim" class="form-control">
