...
<!-- equipo Field -->
<input type="hidden" id="equipo_s" name="nombre" value="">
<!-- Unidad Id Field -->
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE UNIDAD:</label>
      <select name="unidad_id" id="unidads" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE SUB AREA:</label>
      <select name="sub_area_id" id="subareas" class="form-control">
...
<div class="col-md-3">
   <label for="" class="control-label">SELECCIONE USUARIO:</label>
      <select name="usuario_id" id="usuario_ids" class="form-control">
